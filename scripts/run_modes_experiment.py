...
def analyze_and_plot(rows: list[dict], out_dir: str):
    ...
    print(f"✓ Wrote pairwise analysis to {os.path.join(out_dir, 'pairwise_adv.txt')}")
    ...
    print(f"✓ Wrote time-to-95% summary to {t95_path}")
...
def main():
    ...
    print(f"🖼️  Saving plots to: {out_dir_path}")
