...
- Gerkey, Brian P., & Mataric, Maja J. (2004). "A Formal Analysis and Taxonomy 
...
def cbba_frontier_assignment(env, frontiers, agents_list,
                             ...
                             fov_shape="square",  # 'square' uses Linf, 'circle' uses Euclidean
                             fov_margin=0,
            ...
            for j in range(i+1, len(agent_ids)):
                ...
                if strict_fov_exclusion:
                    if fov_shape == "circle":
                        ...
                        # square FOV approximation: Linf separation
