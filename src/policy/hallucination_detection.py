...
class HallucinationDetector:
    ...
    def __init__(self, 
        ...
        References:
            Page (1954) recommends kappa ≈ 0.5σ where σ is noise std dev.
    ...
    def update(self, 
        ...
        Algorithm (Page 1954):
            ...
            3. Normalize: r' = (r - μ_baseline) / σ_baseline
            4. Update CUSUM: S_t = max(0, S_{t-1} + r' - κ)
            5. Alarm if S_t > threshold
        
        The kappa parameter acts as a "deadband" - small deviations
        (|r'| < κ) don't accumulate, preventing false alarms from noise.
        """
